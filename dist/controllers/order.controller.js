...
export const getSingleOrder = TryCatch(async (req, res, next) => {
    ...
    if (myCache.has(key)) {
        ...
        if (!order) {
            return next(new ErrorHandler("Order Not Found!,Invalid Order Id", StatusCodes.NOT_FOUND));
        }
...
export const orderProcess = TryCatch(async (req, res, next) => {
    ...
    if (!order) {
        return next(new ErrorHandler("Order Not Found! Invalid Id", StatusCodes.NOT_FOUND));
    }
    else {
